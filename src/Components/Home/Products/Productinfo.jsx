...
import product8 from './images/pro12.jpg';
import product9 from './images/pro9.jpg';
import product10 from './images/pro10.jpg';
import product11 from './images/pro11.png';
import product12 from './images/pro8.jpg';
import product13 from './images/r1p13.jpg';
import product14 from './images/pro14.jpg';
import product15 from './images/r1p1.jpg';
import product16 from './images/r1p14.jpg';
import product17 from './images/pro17.jpg';
import product18 from './images/pro18.jpg';
import product19 from './images/pro19.jpg';
import product20 from './images/pro8.jpg';
import product21 from './images/pro21.jpeg';
import product22 from './images/pro22.jpeg';
import product23 from './images/pro23.jpeg';
import product24 from './images/pro24.jpeg';
import product25 from './images/pro25.jpeg';
import product26 from './images/pro26.jpg';
    ...
    return (
        <div className='iteams__container'>
            ...
            <div className='pro_iteam_row row1'>
                <Product
                    id="123451"
                    title='ASUS ZenBook 13 Ultra-Slim Laptop”  16GB, 512GB SSD, NumberPad, Thunderb...
        ASUS ZenBook 13 Ultra-Slim Laptop, 13.3” Intel Evo Platform i7-1165G7, 16GB, 512GB SSD, NumberPad, Thunderbolt 4, Wi-Fi 6, Windows 11 Pro, AI Noise-Cancellation,'
                    price={82990}
                    rating={5}
                    image={product1}
                />
            ...
            <div className='pro_iteam_row row2'>
                <Product
                    id="123453"
                    title='Intel 12th Gen. i7-12650H, 40CM FHD 144Hz Gaming Laptop(16GB/1TB ,11 Home/Nvidia RTX3060 6GB GDDR6/Black/2.25Kg)'
                    price={45090}
                    rating={4}
                    image={product3}
                />
                ...
                <Product
                    id="123454"
                    title='Gaming Backlit Keyboard and Mouse Combo,LED Wired Gaming Keyboard,Ergonomic & Wrist Rest Keyboard, Programmable Gaming Mouse.'
                    price={18899}
                    rating={4}
                    image={product4}
                />
                ...
                <Product
                    id="123455"
                    title='Redgear Cosmo 7,1 Usb Gaming Wired Over Ear Headphones With Mic With Virtual Surround Sound,50Mm Driver, Rgb Leds & Remote Control(Blue)'
                    price={11799}
                    rating={4}
                    image={product5}
                />
            ...
            <div className='pro_iteam_row row4'>
                ...
                <Product
                    id="123410"
                    title='Programmable Gaming Mouse for PC/Laptop/Mac – Black'
                    price={1990}
                    rating={5}
                    image={product10}
                />
                ...
                <Product
                    id="123412"
                    title='Royle Gaming Chair for Gamers'
                    price={5090}
                    rating={5}
                    image={product12}
                />
            ...
            <div className='pro_iteam_row home7'>
                ...
                <Product
                    id="123425"
                    title=' Increase your Motivation by reading this book'
                    price={1499}
                    rating={4}
                    image={product26}
                />
